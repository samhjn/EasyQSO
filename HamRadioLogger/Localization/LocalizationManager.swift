...
struct LocalizedStrings {
    ...
    // MARK: - 高级筛选
    static let advancedFilter = "advanced_filter"
    static let searchMode = "search_mode"
    static let fuzzySearch = "fuzzy_search"
    static let exactSearch = "exact_search"
    static let fuzzySearchDesc = "fuzzy_search_desc"
    static let exactSearchDesc = "exact_search_desc"
    static let generalSearch = "general_search"
    static let enterCallsign = "enter_callsign"
    static let enterBand = "enter_band"
    static let enterMode = "enter_mode"
    static let orSelectBands = "or_select_bands"
    static let orSelectModes = "or_select_modes"
    static let dateRange = "date_range"
    static let startDate = "start_date"
    static let endDate = "end_date"
    static let clearStartDate = "clear_start_date"
    static let clearEndDate = "clear_end_date"
    static let frequencyRange = "frequency_range"
    static let minFrequency = "min_frequency"
    static let maxFrequency = "max_frequency"
    static let otherFilters = "other_filters"
    static let resetFilters = "reset_filters"
    static let applyFilters = "apply_filters"
    static let activeFilters = "active_filters"
    static let clearAll = "clear_all"
    
    // MARK: - 导出筛选
    static let useFilterForExport = "use_filter_for_export"
    static let configureExportFilter = "configure_export_filter"
    static let exportFilterActive = "export_filter_active"
    static let recordsToExport = "records_to_export"
    static let exportFiltered = "export_filtered"
    
    // MARK: - 筛选描述
    static let filterSearch = "filter_search"
    static let filterFuzzy = "filter_fuzzy"
    static let filterExact = "filter_exact"
    static let filterCallsign = "filter_callsign"
    static let filterBand = "filter_band"
    static let filterMode = "filter_mode"
    static let filterStartDate = "filter_start_date"
    static let filterEndDate = "filter_end_date"
    static let filterName = "filter_name"
    static let filterQth = "filter_qth"
    static let filterGrid = "filter_grid"
